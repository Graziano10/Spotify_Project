...
const Resgister = () => {
  ...
  return (
    <>
      <div className="bg-white h-full w-full p-10 flex flex-col justify-center items-center  ">
        {/* SVG SPOTIFY */}
        <div className="h-full w-full p-10 flex-col justify-center items-center flex md:max-w-lg md:justify-center md:items-center md:h-full md:w-full md:flex-col">
          <div>
            <svg
              role="img"
              viewBox="0 0 78 24"
          ...
          <h1 className="font-bold tracking-wide text-center text-black text-3xl py-8">
            Sign up for free to start listening.
          </h1>
          <button className="h-12 w-[18rem] tracking-wide rounded-full bg-[#405A93] font-bold text-lg text-white flex justify-center items-center gap-3 transition duration-150 ease-in-out hover:bg-blue-600">
            <svg
              width="26"
              height="26"
              viewBox="0 0 24 24"
          ...
          <button className="h-12 w-[18rem] mt-5 tracking-wide rounded-full bg-white border-[#212121] border-2 text-lg font-bold text-[#212121] flex justify-center items-center gap-3 transition duration-150 ease-in-out hover:bg-secondary">
            <svg
              width="26"
              height="26"
              viewBox="0 0 24 24"
          ...
          {/* --- */}
          <div className="flex gap-1 h-full justify-center items-center my-5">
            <div className="h-[0.1rem] w-[9rem] bg-tertiary"></div>
            <div className="text-xl text-tertiary font-bold tracking-wide">
              or
            </div>
            <div className="h-[0.1rem] w-[9rem] bg-h-[0.1rem] bg-tertiary"></div>
          </div>
              ...
              <div classname="flex items-center mb-4">
                ...
                >
                  ...
                  >
                    ...
                    di contenuti Spotify per scopi di marketing. Nota: i tuoi
                    dati potrebbero essere trasferiti in un paese al di fuori
                    dello SEE (Spazio economico europeo) secondo quanto
