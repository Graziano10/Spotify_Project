...
import HamburgerMenu from "./HamburgerMenù";
    ...
    <>
      {token != null ? (
        <nav className="bg-black z-50 sticky top-0 ">
          <div className="flex flex-wrap items-center justify-between mx-4 p-1 font-semibold tracking-wider">
            <a href="https://flowbite.com/" className="flex items-center">
              ...
              <span className="self-center text-2xl font-semibold tracking-wide text-white ml-2 hidden md:block">
                Spotify
              </span>
            </a>
            <div className="flex items-center gap-3">
              ...
              <a href="#">
                <button className="w-32 h-10 bg-invert rounded-full text-black">
                  APP
                </button>
              </a>
              <Fade right>
